    ...
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y divide-gray-200">
        <tbody className="bg-white divide-y divide-gray-200">
          ...
          <tr>
            <th className="min-w-[150px] min-h-[100px] px-1 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50">
              サムネイル
            </th>
            {data.map((post) => (
              <td key={post.id} className="px-2 py-2 whitespace-nowrap">
                <img
                  src={post.mediaProductType === 'FEED' ? post.mediaUrl : post.thumbnailUrl}
                  alt="サムネイル"
                  className="min-h-[100px] h-auto max-w-[100%] object-cover rounded"
                />
              </td>
            ))}
          </tr>
