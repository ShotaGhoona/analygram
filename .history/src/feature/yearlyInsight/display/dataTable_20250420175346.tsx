      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-200 bg-gray-50">
            ...
            <th className="w-[5%] px-4 py-2 text-right font-medium">いいね</th>
            <th className="w-[5%] px-4 py-2 text-right font-medium">コメント</th>
            <th className="w-[5%] px-4 py-2 text-right font-medium">保存</th>
            <th className="w-[5%] px-4 py-2 text-right font-medium">シェア</th>
          </tr>
        </thead>
        <tbody>
