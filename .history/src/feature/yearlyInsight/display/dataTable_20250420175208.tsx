      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-200 bg-gray-50">
            <th className="w-1/12 px-4 py-2 text-left font-medium">年, 月</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">フォロワー数</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">新規フォロワー数</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">リーチ</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">インプレッション数</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">プロフィールのアクセス</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">ウェブサイトのタップ</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">いいね</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">コメント</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">保存</th>
            <th className="w-1/12 px-4 py-2 text-right font-medium">シェア</th>
          </tr>
        </thead>
        <tbody>
