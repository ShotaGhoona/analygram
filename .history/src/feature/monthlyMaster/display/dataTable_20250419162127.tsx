      ...
      <table className="min-w-full divide-y divide-gray-200">
        <tbody className="bg-white divide-y divide-gray-200">
          ...
          <tr>
            ...
            {data.map((post) => (
              <td key={post.id} className="px-6 flex flex-col justify-center py-4 whitespace-nowrap">
                <img
          ...
          <tr>
            <th className="w-[150px] px-1 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50">
              いいね
            </th>
            {data.map((post) => (
