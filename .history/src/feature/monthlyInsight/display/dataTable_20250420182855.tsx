        ...
        <tbody>
          {monthlyData.map((row, index) => (
            <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
              ...
              <td className="text-[12px] py-0.5 px-2 text-center">{row.reachTotal.toLocaleString()}</td>
              <td className="text-[12px] py-0.5 px-2 text-center">{row.profileVisits.toLocaleString()}</td>
              <td className="text-[12px] py-0.5 px-2 text-center">{row.webTaps.toLocaleString()}</td>
            </tr>
          ))}
        </tbody>
      </table>
