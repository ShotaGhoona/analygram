...
export default function Header() {
  ...
  return (
    <header className="">
      <div className="w-full p-4 bg-[#ECE9C3] shadow">
      ...
      <div className="w-full flex justify-between px-12 py-4 gap-4">
        <div className="flex items-center gap-4">
          <Link href="/yearly">
            <h2 className={`text-medium font-semibold mb-2 py-2 px-8 rounded-full shadow-md transition-colors ${
