  ...
  const monthlyData = insights.reduce<Record<string, any>>((acc, curr) => {
    ...
    if (!acc[yearMonth]) {
      acc[yearMonth] = {
        ...
        feed_likes: curr.feedLikes,
        feed_comments: curr.feedComments,
        feed_shares: curr.feedShares,
        feed_saves: curr.feedSaves,
      };
    } else {
      acc[yearMonth].feed_reach += curr.feedReach;
      ...
      acc[yearMonth].feed_likes += curr.feedLikes;
      acc[yearMonth].feed_comments += curr.feedComments;
      acc[yearMonth].feed_shares += curr.feedShares;
      acc[yearMonth].feed_saves += curr.feedSaves;
    }
