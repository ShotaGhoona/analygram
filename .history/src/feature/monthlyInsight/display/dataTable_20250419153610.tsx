      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b bg-gray-50">
            ...
            <th className="w-1/6 px-4 py-2 text-center font-medium">新規フォロワー数</th>
            ...
            <th className="w-1/6 px-4 py-2 text-center font-medium">プロフィールのアクセス</th>
            <th className="w-1/6 px-4 py-2 text-center font-medium">ウェブサイトのタップ</th>
          </tr>
        </thead>
        <tbody>
          {monthlyData.map((row, index) => (
            <tr key={index} className="border-b-gray-700 hover:bg-gray-50">
