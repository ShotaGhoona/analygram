      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b bg-gray-50">
            ...
            <th className="w-1/6 px-1 py-2 text-center font-medium">新規<br />フォロワー</th>
            ...
            <th className="w-1/6 px-1 py-2 text-center font-medium">プロフアクセス</th>
            <th className="w-1/6 px-1 py-2 text-center font-medium">ウェブサイトのタップ</th>
          </tr>
        </thead>
        <tbody>
